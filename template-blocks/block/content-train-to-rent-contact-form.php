<?php
/**
 * Block Name: Train to rent contact form
 *
 *
 */
...
$id = 'traintorentcontactform-' . $block['id'];
...
<section id="<?php echo $id; ?>">
  <div class="container line-after">
    <div class="row">
      <div class="col">
        <h1><?php the_field('traintorentcontactform_heading') ?></h1>
        <h2><?php the_field('traintorentcontactform_subheading') ?></h2>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col">
        <?php the_field('traintorentcontactform_form_shortcode') ?>
      </div>
    </div>
  </div>
</section>
